...
class QuizPage {
  ...
  render(ctx) {
    ...
    ctx.lineWidth = 1;
    ctx.strokeRect(0, 0, this.width, 80);

    // 左侧：题目序号
    ctx.font = '18px Arial';
    ctx.fillStyle = '#333333'; // 深灰色文字
    ctx.textAlign = 'left';
    ctx.fillText(`第${this.currentQuestion + 1}/${this.questions.length}题`, 20, 45);

    // 右侧：计时显示
    ctx.font = '16px Arial';
    ctx.fillStyle = '#666666';
    ctx.textAlign = 'right';
    ctx.fillText(`剩余时间: ${this.timeLeft}s`, this.width - 120, 45);
    ...
    ctx.textAlign = 'right';
    ctx.fillText(question.type, this.width - 20, 45);

    // 绘制题目内容卡片
    ctx.fillStyle = '#FFFFFF';
    ctx.fillRect(20, 100, this.width - 40, 120);
    ctx.strokeStyle = '#E0E0E0';
    ctx.lineWidth = 1;
    ctx.strokeRect(20, 100, this.width - 40, 120);
    ...
    question.options.forEach((option, index) => {
      ...
      if (this.isAnswered) {
        if (index === question.correctAnswer) {
          ctx.fillStyle = '#E8F5E8'; // 正确选项绿色背景
          ctx.strokeStyle = '#4CAF50';
        } else if (index === this.selectedOption) {
          ctx.fillStyle = '#FFEBEE'; // 错误选项红色背景
      ...
      ctx.fillRect(20, optionYStart + index * optionHeight, this.width - 40, 50);
      ctx.strokeRect(20, optionYStart + index * optionHeight, this.width - 40, 50);
    ...
    if (this.showResult) {
      ...
      ctx.fillStyle = '#FFFFFF';
      ctx.fillRect(40, this.height / 2 - 100, this.width - 80, 200);
      ctx.strokeStyle = '#2196F3';
      ctx.lineWidth = 2;
      ctx.strokeRect(40, this.height / 2 - 100, this.width - 80, 200);
      ...
      if (this.currentQuestion < this.questions.length - 1) {
        ...
        ctx.fillRect(this.width / 2 - 110, this.height / 2 + 60, 200, 50);
        ctx.fillStyle = '#FFFFFF';
        ctx.font = '16px Arial';
        ctx.textAlign = 'center';
    ...
    if (!this.showResult) {
      ...
      ctx.fillRect(20, this.height - 60, 80, 40);
      ctx.fillStyle = '#FFFFFF';
      ctx.font = '14px Arial';
      ctx.textAlign = 'center';
      ...
      ctx.fillRect(120, this.height - 60, 100, 40);
      ctx.fillStyle = '#FFFFFF';
      ctx.font = '14px Arial';
      ctx.textAlign = 'center';
      ...
      ctx.fillRect(this.width - 120, this.height - 60, 100, 40);
      ctx.fillStyle = '#FFFFFF';
      ctx.font = '14px Arial';
      ctx.textAlign = 'center';
